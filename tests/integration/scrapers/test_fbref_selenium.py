"""
FBref Selenium Scraper Integration Tests
=========================================

Integration tests for FBrefSeleniumScraper with Cloudflare bypass.
...
Run with: pytest tests/integration/scrapers/test_fbref_selenium.py -v -s
"""
...
@pytest.fixture
def fbref_scraper():
    """Create FBrefSeleniumScraper instance for testing."""
...
class TestFBrefSeleniumScraperUnit:
    """Unit tests for FBrefSeleniumScraper (no real HTTP requests)."""
...
class TestFBrefSeleniumScraperIntegration:
