...
#
# Обязан быть длиннее самого широкого окна полосы. Регрессия 2026-08-12: при 8 часах
# фоновая волна, стартующая в 00:00, умирала по AirflowTaskTimeout в 08:00 — за 5 ч 45 мин
# до собственного дедлайна 13:45. Следствия шире потерянного окна: жёсткий SIGTERM
# вместо мягкой отсрочки красит ран, поэтому не закрывается публикация, не триггерится
# silver и не выполняется advance_after_success — курсор полос стоит, BACKFILL не
# наступает никогда.
CHILD_TIMEOUT_MINUTES = 15 * 60
