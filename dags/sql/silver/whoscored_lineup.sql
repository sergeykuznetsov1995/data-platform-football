...
-- bronze.whoscored_lineups_current (latest successful match manifest batch;
-- matchCentreData home/away.players[], issue #708).
-- Feeds the WhoScored branch of gold.fct_lineup (#693).
--
-- Source:
--   bronze.whoscored_lineups_current (isFirstEleven / position / shirtNo / rating,
...
--   * The current view excludes partial batches. ROW_NUMBER remains as a
--     compatibility guard for migrated legacy rows.
