...
--
-- Sources: iceberg.silver.fbref_match_enriched + iceberg.gold.entity_xref
-- PK: match_id
...
LEFT JOIN iceberg.gold.entity_xref home_x
    ON home_x.entity_type='team' AND home_x.source='fbref'
   AND home_x.source_id = m.home  AND home_x.season = m.season
   AND home_x.league    = m.league
LEFT JOIN iceberg.gold.entity_xref away_x
    ON away_x.entity_type='team' AND away_x.source='fbref'
   AND away_x.source_id = m.away  AND away_x.season = m.season
