...
# Мусор в env-файле не должен ронять шаг drain арифметикой: DAG свой batch зажимает в 1..64,
# здесь тот же смысл — непонятное значение читаем как дефолт.
case "$BREAKER_MAX" in ''|*[!0-9]*|0) BREAKER_MAX=3 ;; esac
