...
# * per class-A tournament, the current season(s) and the season that has
#   just finished;
...
# Friendlies and pre-season exhibitions stay outside the denominator and
# outside collection (``EXCLUDED_TOURNAMENT_IDS``).
# --------------------------------------------------------------------------
