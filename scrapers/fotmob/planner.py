...
# У CURRENT-полосы возврат есть: раннер ставит такому скоупу next_retry_at не позже
# +48 ч — раньше, если впереди матч по расписанию (#1546) или дыра не подтверждена.
