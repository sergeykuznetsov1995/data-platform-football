...
> Источник строк: `bench_whoscored_baseline.json` (events),
> `bench_whoscored_schedule_baseline.json` (schedule),
> `bench_sofifa_baseline.json` (player_ratings) — артефакты в `docs/research/data/`.
