...
`pending` (счётчик `unavailable_tournaments` в отчёте) — иначе очередь приоритета выбирала бы его
первым в каждом прогоне и не двигалась. 403, 429, 5xx и бюджет по-прежнему прерывают прогон.
