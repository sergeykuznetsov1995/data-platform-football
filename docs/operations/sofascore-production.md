...
история во время дейли: X скоупов · дейли в пуле актуалки: Y (за дд.мм UTC)`. Ожидание — не
...
позднего из старта DagRun и конца предыдущих задач прогона; зазоры ≤ 60 с — переходы планировщика,
не ожидание. ✅ — ни один прогон не ждал и ни одна задача дейли не заняла пул актуалки. Пока модуль
